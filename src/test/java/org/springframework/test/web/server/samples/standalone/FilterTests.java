...
public class FilterTests {
	...
	@Test
	public void conditionalSuffixFilterExecutes() throws Exception {
		standaloneSetup(new PersonController())
	...
	@Test
	public void conditionalExactFilterExecutes() throws Exception {
		standaloneSetup(new PersonController())
	...
	@Test
	public void conditionalFilterSkipped() throws Exception {
		standaloneSetup(new PersonController())
	...
	@Test
	public void filterWrapRequestResponse() throws Exception {
		standaloneSetup(new PersonController())
			.addFilters(new WrapRequestResponseFilter()).build()
			.perform(post("/user"))
				.andExpect(model().attribute("principal", WrapRequestResponseFilter.PRINCIPAL_NAME));
	}
	...
	private static class WrapRequestResponseFilter extends OncePerRequestFilter {
